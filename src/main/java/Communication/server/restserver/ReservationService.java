...
public class ReservationService {
    ...
    public Response CreateMeeting(String data) {
        ...
        Reservation reservation = new Reservation(reservationsSize + 1, userCollection.getUserById(reservationCreateResponse.getUserId()), false, LocalDateTime.now(), LocalDateTime.now().plusMinutes((long) reservationCreateResponse.getDuration()));
