...
public class ReservationService {
    ...
    public Response CreateMeeting(String data) {
        ...
        Reservation reservation = new Reservation(reservationsSize + 1, user, false, LocalDateTime.now(), LocalDateTime.now().plusMinutes((long) reservationCreateResponse.getDuration()));
